...
class Following extends React.Component{
  ...
  dispatch_event() {
    ...
    this.props.dispatch(user_thunks.fetch_user_following(username, 0, 100))
  }
  render() {
...
const mapStateToProps = (state)=>{
  return {
    users: state.user.following.following,
    isFetching: state.user.following.isFetching,
    hasError: state.user.following.hasError
  }
};
